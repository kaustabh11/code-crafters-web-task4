document.addEventListener('DOMContentLoaded', function() {
    ...
    form && (form.onsubmit = function(e){
        ...
        if ( target > weight ){
            ...
            document.querySelector('.invalidTarget').textContent = 'Target weight must be smaller than current weight.'
    ...
    edit && (edit.onclick = function(e){
        ...
        editForm.onsubmit = function(e){
            ...
            if ( editTarget > editWeight ){
                ...
                document.querySelector('.invalidTarget2').textContent = 'Target weight must be smaller than current weight.'
